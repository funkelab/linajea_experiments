...
if __name__ == "__main__":
    ...
    parser.add_argument("--scale_z", type=str, default=None,
                        help="scale z by this factor")
    ...
    if args.scale_z is not None:
        scale_z = eval(args.scale_z)
        logger.info("scale z %s", scale_z)
